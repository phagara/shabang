...
#if ! defined SHA224_HASH_HEADER_
#define SHA224_HASH_HEADER_
...
#define sha224_add_data  sha224_add_bytes


int sha224_initialize( SHA224_Context * context );
int sha224_add_bytes( SHA224_Context * context,
                      const void     * data,
                      size_t           num_bytes );
int sha224_add_bits( SHA224_Context * context,
                     const void     * data,
                     size_t           num_bits );
int sha224_calculate( SHA224_Context * context,
